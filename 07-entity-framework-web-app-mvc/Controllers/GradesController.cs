...
namespace _07_entity_framework_web_app_mvc.Controllers
{
    public class GradesController : Controller
    {
        ...
        // Grades/<id>/Students
        [HttpGet]
        [Route("Grades/{id:int}/Students")]
        public async Task<IActionResult> StudentsByGrade(int id)
        {
            var grade = await _context.Grade.Include(g => g.Students).FirstOrDefaultAsync(g => g.Id == id);
            ...
            // var students = _context.Student.Where(s => s.GradeId == id).ToList();
